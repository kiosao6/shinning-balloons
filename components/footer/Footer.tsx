...
export const Footer = () => {
  return (
    <footer className="px-8 py-24 mx-auto text-sm bg-moon-50 border-t-moon-100 border-t text-base-heading text-center p-4 md:text-left">
      ...
      <p className="leading-relaxed text-base-heading max-w-7xl mx-auto">Developed by <a href="https://www.gabrielmaestre.com" className="font-medium text-base-heading underline underline-offset-2 hover:text-neutral-600">Gabriel Maestre</a> using Next.js App Router Syntax.</p>
