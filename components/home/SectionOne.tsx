  ...
  return (
    <section className="mt-16 mb-16 flex px-8 flex-col max-w-7xl mx-auto lg:flex-row lg:justify-between lg:gap-8">
        <div className="max-w-xl mx-auto lg:mx-0">
          <p className="text-5xl mb-10 font-bold tracking-tight text-center lg:text-left lg:text-6xl lg:mb-6 md:max-w-sm md:mx-auto lg:max-w-max lg:mx-0">Never miss a celebration again</p>
