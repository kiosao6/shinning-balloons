    ...
    <main className="px-8 mx-auto max-w-6xl text-base-heading">
      ...
      <div className="flex mb-16 flex-col max-w-3xl gap-y-3 text-base text-base-heading/70 leading-relaxed mx-auto md:text-lg">
        ...
        <ul className="pl-8 list-disc md:pl-12">
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Shinning Balloons.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Shinning Balloons, accessible from <a href="shinningballoons.com" rel="external nofollow noopener" target="_blank">shinningballoons.com</a></p>
          </li>
          <li>
