...
export default function ArticlePage() {
  ...
  const links = [
    ...
    {
      name: "The Not-So-Fun Side of Balloons",
  ...
  return (
    <main>
      <section className="mt-10 mb-24 px-8 max-w-6xl mx-auto text-base-heading ">
        ...
        <div className="mt-12 flex flex-col lg:flex-row-reverse lg:justify-between">
          <div className="border-b pb-4 lg:border-l lg:w-72 lg:pl-8 lg:border-b-0 lg:pb-0 ">
          ...
          <div className="mt-12 max-w-[800px] lg:mt-0">
            <Image
              src="/seaballoon.webp"
              width={700}
              height={700}
            ...
            <section className="mt-12 md:pr-20">
              <h3 className="text-xl md:text-2xl font-bold tracking-tight mb-4 text-base-heading">
                The problem with Balloons
              </h3>
              <div className="text-base-heading/70 leading-relaxed [&>*]:space-y-4">
            ...
            <section className="mt-12 md:pr-20">
              ...
              <p className="text-base-heading/70 leading-relaxed mb-4">
              Discover reusable and biodegradable options for colorful and festive decorations that won&#39;t harm the planet.
              </p>
              <div className="mb-4">
                <h4 className="text-lg md:text-xl font-bold tracking-tight mb-4 text-base-heading">1. Garlands</h4>
              ...
              <div className="mb-4">
                <h4 className="text-lg md:text-xl font-bold tracking-tight mb-4 text-base-heading">2. Streamers</h4>
                <p className="text-base-heading/70">
