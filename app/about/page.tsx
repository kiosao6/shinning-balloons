  ...
  return (
    <main className="px-8 mx-auto max-w-6xl text-base-heading">
      <section className="mt-16 max-w-3xl mx-auto">
        <p className="text-base mb-2 text-moon-500 font-semibold mx-auto md:text-center md:text-lg">About</p>
        <h1 className="text-4xl mb-6 font-bold tracking-tight md:text-center lg:text-5xl">Learning about Shinning Balloons</h1>
      </section>
      <section className="mb-16 max-w-3xl mx-auto flex flex-col gap-y-8">
